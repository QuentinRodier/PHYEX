...
!
IF( .NOT.ASSOCIATED(XGAMINC_RIM1) ) THEN
  CALL RAIN_ICE_PARAM_ALLOCATE('XGAMINC_RIM1', RAIN_ICE_PARAMN%NGAMINC)
  !$acc enter data create (XGAMINC_RIM1)
END IF
IF( .NOT.ASSOCIATED(XGAMINC_RIM2) ) THEN
  CALL RAIN_ICE_PARAM_ALLOCATE('XGAMINC_RIM2', RAIN_ICE_PARAMN%NGAMINC)
  !$acc enter data create (XGAMINC_RIM2)
END IF
IF( .NOT.ASSOCIATED(XGAMINC_RIM4) ) THEN
  CALL RAIN_ICE_PARAM_ALLOCATE('XGAMINC_RIM4', RAIN_ICE_PARAMN%NGAMINC)
...
!
IF( .NOT.ASSOCIATED(XKER_RACCSS) ) THEN
  CALL RAIN_ICE_PARAM_ALLOCATE('XKER_RACCSS', RAIN_ICE_PARAMN%NACCLBDAS,RAIN_ICE_PARAMN%NACCLBDAR)
  !$acc enter data create(XKER_RACCSS)
END IF
IF( .NOT.ASSOCIATED(XKER_RACCS ) ) THEN
  CALL RAIN_ICE_PARAM_ALLOCATE('XKER_RACCS', RAIN_ICE_PARAMN%NACCLBDAS,RAIN_ICE_PARAMN%NACCLBDAR)
  !$acc enter data create(XKER_RACCS)
END IF
IF( .NOT.ASSOCIATED(XKER_SACCRG) ) THEN
  CALL RAIN_ICE_PARAM_ALLOCATE('XKER_SACCRG', RAIN_ICE_PARAMN%NACCLBDAR,RAIN_ICE_PARAMN%NACCLBDAS)
...
!
IF( .NOT.ASSOCIATED(XKER_SDRYG) ) THEN 
  CALL RAIN_ICE_PARAM_ALLOCATE('XKER_SDRYG', RAIN_ICE_PARAMN%NDRYLBDAG,RAIN_ICE_PARAMN%NDRYLBDAS)
